...
PLUGIN.containerModel = {
	category 		=	"models/props_lab/filecabinet02.mdl",
	category2		=	"models/props_lab/filecabinet02.mdl",
	category3		=	"models/props_lab/filecabinet02.mdl",
	category4		=	"models/props_c17/furnitureStove001a.mdl"
}
...
if (SERVER) then
	...
	function PLUGIN:Think()
		...
		if nut.config.get("wicEnabled") then
			...
			if (#self.spawnedContainers <= nut.config.get("wicMaxWorldContainers") or #self.spawnedContainers <= (2*#self.contPoints)) then 
