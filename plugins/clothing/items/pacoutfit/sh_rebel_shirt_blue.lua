...
ITEM:hook("Equip", function(item)
	if (SERVER) then
		...
		if(verifyItem(item)) then
			client:ConCommand("say /me coloca a vestimenta rebelde, ajusta o colete.")
...
ITEM:hook("EquipUn", function(item)
	if (SERVER) then
		local client = item.player
		client:ConCommand("say /me retira as vestimentas de rebelde.")
