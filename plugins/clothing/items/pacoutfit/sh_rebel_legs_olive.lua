ITEM.name = "Rebel pants olive"
ITEM.model = Model("models/tnb/items/aphelion/pants_rebel.mdl")
ITEM.width = 1
ITEM.height = 1
ITEM.desc = "Standard rebel pants, stylish and versatile. Also, they're olive."
