...
if (SERVER) then
		...
		local data = {}
			for k, v in ipairs(ents.FindByClass("nut_talker")) do
				...
				data[#data + 1] = {
					...
					angles = v:GetAngles(),
					model = v:GetModel(),
					bodygroups = v:getNetVar("bodygroups", {}),
	...
	function PLUGIN:LoadData()
		for k, v in ipairs(self:getData() or {}) do
			...
			for k, v in pairs(v.bodygroups) do
				entity:SetBodygroup( entity:FindBodygroupByName(k), v )
			end
			entity:setNetVar("bodygroups", v.bodygroups)
