...
QUEST.quickRewards = {
	currency = 100,
	items = {
		{ uid = "tomato", amount = 1, data = {} },
	}	
}

QUEST.randomItem = { -- 
	{ uid = "tomato", min = 1, max = 1 },
}
function QUEST:GenerateData( player )
	local tbl = {}
	for i = 0, 0 do
...
---------------------------------
--- QUEST DO FININHO DO WENDELL
--- PEGA O PRENSADAO PRO PAI
--- THE ITEM HAS TO BE COLLECTED WILL BE RANDOMIZED IN randomItem. 

local QUEST = {}
QUEST.uniqueID = "wendell09"
QUEST.name = "O pai ta baiano"
QUEST.desc = "Preciso que você vá na Cesaca e pegue o bom pra mim" -- If you don't know how it's working, Just check in sh_advhandler.lua in dialogue.
QUEST.quickRewards = {
	currency = 100,
	items = {
		{ uid = "tomato", amount = 1, data = {} },
